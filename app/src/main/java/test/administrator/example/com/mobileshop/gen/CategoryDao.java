...
public class CategoryDao extends AbstractDao<Category, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Cat_path = new Property(2, String.class, "cat_path", false, "CAT_PATH");
        public final static Property Parent_id = new Property(3, int.class, "parent_id", false, "PARENT_ID");
        public final static Property Good_count = new Property(4, int.class, "good_count", false, "GOOD_COUNT");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CATEGORY\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"CAT_PATH\" TEXT," + // 2: cat_path
                "\"PARENT_ID\" INTEGER NOT NULL ," + // 3: parent_id
                "\"GOOD_COUNT\" INTEGER NOT NULL ," + // 4: good_count
    ...
    protected final void bindValues(DatabaseStatement stmt, Category entity) {
        ...
        if (cat_path != null) {
            stmt.bindString(3, cat_path);
        }
        stmt.bindLong(4, entity.getParent_id());
        stmt.bindLong(5, entity.getGood_count());
    ...
    public Category readEntity(Cursor cursor, int offset) {
        Category entity = new Category( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // cat_path
            cursor.getInt(offset + 3), // parent_id
            cursor.getInt(offset + 4), // good_count
    ...
    public void readEntity(Cursor cursor, Category entity, int offset) {
        ...
        entity.setCat_path(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setParent_id(cursor.getInt(offset + 3));
        entity.setGood_count(cursor.getInt(offset + 4));
